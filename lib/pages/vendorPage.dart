...
class vendorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var account = Profilo('VN000001', 'Won-hee', 'Lee', 'via benedetto Crispano 28', 'vogliomorire1', 'voglio@morire.it', 'lib/images/profile_picture.jpg', 'Bio del sue profilo, fidati che é troppo bravo a fare le cose');
    return Scaffold(
                  ...
                  child: ListView(
                    children: [
                      ...
                      const Row(
                        children: [
                          SizedBox(width: 10),
                          Text('Le suo aste', style: TextStyle(fontSize: 27, color: Colors.white),),
                        ],
                      ),
